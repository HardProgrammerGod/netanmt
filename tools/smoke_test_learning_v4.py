"""Dependency-free release smoke test for Neta Telegram v4.
...
migration = (ROOT / "migrations" / "2026_09_15_learning_v4.sql").read_text(encoding="utf-8")
...
print("SMOKE_V4_OK: product, security, UI and migration invariants passed")

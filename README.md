...
`nmt_2026_pack_v1_7.json` adds 120 original practice questions (20 per Task 1–6). Install it with `supabase_v1_7_content_pack4.sql` and validate locally with:

```bash
python tools/validate_content.py content/nmt_2026_pack_v1_7.json
```

# Neta NMT English — Telegram v5

> Current production candidate: v5. Install: `INSTALL_V5.md`.  
> If upgrading from v4, run only `migrations/2026_09_15_learning_v5.sql` before deploying v5 code.

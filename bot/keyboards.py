...
def get_main_keyboard(
    ...
    is_admin: bool = False,
    had_daily_errors: bool = False,
    **_,
) -> InlineKeyboardMarkup:
    b = InlineKeyboardBuilder()
    if daily_completed:
        primary_text = "🧠 Закріпити помилки · 5" if had_daily_errors else "🚀 Підвищити складність · 5"
        primary_mode = "focus" if had_daily_errors else "challenge"
        b.row(InlineKeyboardButton(text=primary_text, callback_data=f"start_practice:{primary_mode}:5"))
        b.row(InlineKeyboardButton(text="🔥 Повне тренування · 10", callback_data="start_practice:full:10"))
    else:
        b.row(InlineKeyboardButton(text="⚡ Почати Daily · 4", callback_data="start_today"))

    b.row(InlineKeyboardButton(text="📊 Мій прогрес", callback_data="show_progress"))
    b.row(
        InlineKeyboardButton(text="🏆 Рейтинг", callback_data="show_friends"),
        InlineKeyboardButton(text="🎓 Курс", callback_data="show_course"),
    )
    b.row(
        InlineKeyboardButton(text="📣 Канал", callback_data="show_channel"),
        InlineKeyboardButton(text="⚙️ Налаштування", callback_data="show_settings"),
    )
    if is_admin:
...
def get_daily_result_keyboard(had_errors: bool = False, leaderboard_opt_in: bool | None = None) -> InlineKeyboardMarkup:
    b = InlineKeyboardBuilder()
    if had_errors:
        b.row(InlineKeyboardButton(text="🧠 Закріпити помилки · 5", callback_data="start_practice:focus:5"))
    else:
        b.row(InlineKeyboardButton(text="🚀 Підвищити складність · 5", callback_data="start_practice:challenge:5"))
    b.row(InlineKeyboardButton(text="🔥 Повне тренування · 10", callback_data="start_practice:full:10"))
    if leaderboard_opt_in is False:
        b.row(InlineKeyboardButton(text="🏆 Долучитися до рейтингу", callback_data="leaderboard_on"))
    b.row(InlineKeyboardButton(text="🏠 Меню", callback_data="back_to_main"))
    return b.as_markup()


def get_practice_picker_keyboard() -> InlineKeyboardMarkup:
    b = InlineKeyboardBuilder()
    b.row(InlineKeyboardButton(text="🧠 Тренувати слабкі теми · 5", callback_data="start_practice:focus:5"))
    b.row(InlineKeyboardButton(text="🔥 Повне тренування · 10", callback_data="start_practice:full:10"))
    b.row(InlineKeyboardButton(text="⬅️ Назад", callback_data="back_to_main"))
    return b.as_markup()


def get_practice_result_keyboard(had_errors: bool = False, leaderboard_opt_in: bool | None = None) -> InlineKeyboardMarkup:
    b = InlineKeyboardBuilder()
    if had_errors:
        b.row(InlineKeyboardButton(text="🧠 Закріпити помилки · 5", callback_data="start_practice:focus:5"))
    else:
        b.row(InlineKeyboardButton(text="🚀 Спробувати складніше · 5", callback_data="start_practice:challenge:5"))
    b.row(InlineKeyboardButton(text="🔥 Повне тренування · 10", callback_data="start_practice:full:10"))
    if leaderboard_opt_in is False:
        b.row(InlineKeyboardButton(text="🏆 Долучитися до рейтингу", callback_data="leaderboard_on"))
    b.row(InlineKeyboardButton(text="🏠 Меню", callback_data="back_to_main"))
...
def get_progress_keyboard(has_new_diagnostic: bool = False) -> InlineKeyboardMarkup:
    ...
    if not has_new_diagnostic:
        b.row(InlineKeyboardButton(text="🎯 Пройти карту навичок", callback_data="start_diagnostic"))
    b.row(InlineKeyboardButton(text="🧠 Тренувати слабкі теми", callback_data="start_practice:focus:5"))
    b.row(InlineKeyboardButton(text="⬅️ Назад", callback_data="back_to_main"))
    return b.as_markup()
...
def get_settings_keyboard(enabled: bool, leaderboard_opt_in: bool = False) -> InlineKeyboardMarkup:
    b = InlineKeyboardBuilder()
    if enabled:
        b.row(InlineKeyboardButton(text="Вимкнути нагадування", callback_data="reminder_off"))
    b.row(
        InlineKeyboardButton(text="17:00", callback_data="reminder_set:17:00"),
        InlineKeyboardButton(text="19:00", callback_data="reminder_set:19:00"),
        InlineKeyboardButton(text="21:00", callback_data="reminder_set:21:00"),
    ...
    if leaderboard_opt_in:
        b.row(InlineKeyboardButton(text="Вийти з рейтингу", callback_data="leaderboard_off"))
...
def get_course_keyboard(interested: bool = False) -> InlineKeyboardMarkup:
    b = InlineKeyboardBuilder()
    if not interested:
        b.row(InlineKeyboardButton(text="🔔 Повідомити про запуск", callback_data="course_interest"))
    b.row(InlineKeyboardButton(text="⬅️ Назад", callback_data="back_to_main"))
    return b.as_markup()
...
def get_friends_keyboard(share_url: str, leaderboard_opt_in: bool = False) -> InlineKeyboardMarkup:
    b = InlineKeyboardBuilder()
    if not leaderboard_opt_in:
        b.row(InlineKeyboardButton(text="🏆 Увійти в рейтинг", callback_data="leaderboard_on"))

...
def get_daily_result_keyboard(had_errors: bool = False) -> InlineKeyboardMarkup:
    b = InlineKeyboardBuilder()
    if had_errors:
    ...
    b.row(InlineKeyboardButton(text="🔥 Повне тренування · 10", callback_data="start_practice:full:10"))
    b.row(InlineKeyboardButton(text="🏠 Завершити", callback_data="back_to_main"))
    return b.as_markup()
...
def get_practice_result_keyboard(had_errors: bool = False) -> InlineKeyboardMarkup:
    b = InlineKeyboardBuilder()
    if had_errors:
        b.row(InlineKeyboardButton(text="🧠 Закріпити помилки · 5", callback_data="start_practice:focus:5"))
    else:

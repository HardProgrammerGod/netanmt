...
def get_progress_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.button(
        text="🎯 Тренувати слабкі теми",
        callback_data="quiz_cat_personalized",
    )

    builder.button(
        text="🧪 Повна симуляція НМТ",
        callback_data="quiz_full_simulation",
    )
...
def get_manager_payment_keyboard(
...
def get_quiz_categories_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.button(
        text="🔥 Premium Focus — 10 завдань",
        callback_data="quiz_premium_focus",
    )

    builder.button(
        text="🧪 Повна симуляція НМТ — 32",
        callback_data="quiz_full_simulation",
    )
...
def get_diagnostic_result_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.button(
        text="🎯 Прокачати мої слабкі теми",
        callback_data="start_personalized_after_diagnostic",
    )
...
def get_admin_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.button(
        text="🚀 Launch / waitlist",
        callback_data="admin_launch_waitlist",
    )

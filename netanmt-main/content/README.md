...
Фінальний v3 release **не вимагає** окремого content SQL-файлу: learning migration працює з уже наявною таблицею `questions` і має fallback, якщо curated intro-коди з v1.7 не були імпортовані раніше.
...
Згенерований SQL є content import, а не частиною обов’язкової v3 schema migration.
